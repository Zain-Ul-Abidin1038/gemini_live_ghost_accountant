# Ghost Accountant - Installation Guide
...
#### Step 1: Download APK
1. Go to [GitHub Releases](https://github.com/your-org/ghost_accountant/releases)
...
2. Find **Ghost Accountant** in your apps
3. Tap **Open**
...
**Important:** Ghost Accountant requires a Gemini API key for AI features.
...
**Cost:** Gemini API is free for moderate usage (~$0.78/month for typical use)
...
#### Camera Not Working
**Solution:**
1. Go to Settings > Apps > Ghost Accountant
2. Tap Permissions
...
#### App Crashes
**Solution:**
1. Clear app cache: Settings > Apps > Ghost Accountant > Clear Cache
2. Restart device
3. Reinstall app
...
Congratulations! Ghost Accountant is now installed and configured. 
...
- Visit [GitHub Discussions](https://github.com/your-org/ghost_accountant/discussions)

---

**Welcome to Ghost Accountant - Your AI-Powered Financial Life OS! 🚀**
