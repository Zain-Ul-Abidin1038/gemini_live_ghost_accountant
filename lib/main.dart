...
import 'package:ghost_accountant/amplifyconfiguration.dart';

void main() async {
  try {
    WidgetsFlutterBinding.ensureInitialized();
    
    safePrint('🚀 Initializing Ghost Accountant with Gemini API (GCP) + AWS');

    // Load environment variables for Gemini API key
    try {
      await dotenv.load(fileName: ".env");
      safePrint('✓ Environment variables loaded (Gemini API key)');
    } catch (e) {
