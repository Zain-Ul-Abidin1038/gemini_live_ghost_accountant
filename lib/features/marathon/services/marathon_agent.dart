...
import 'package:ghost_accountant/features/finance/services/finance_service.dart';
import 'dart:convert';
...
/// Uses Gemini API (GCP) thinking capabilities to plan, execute, and self-correct
class MarathonAgent {
...
Return JSON format:
{
  ...
  "successCriteria": ["criteria1", "criteria2"]
    ...
    final planResponse = await gemini.sendMessage(
      prompt: planPrompt,
  ...
  Future<DayResult> executeDayTask({
    ...
    // Execute each task with Gemini 3 Pro
