...
import 'package:ghost_accountant/core/services/gemini_validator.dart';
import 'package:ghost_accountant/features/receipts/domain/receipt.dart';
import 'package:ghost_accountant/features/receipts/services/receipt_repository.dart';
import 'package:amplify_flutter/amplify_flutter.dart';
import 'package:uuid/uuid.dart';

final receiptPipelineProvider = Provider((ref) => ReceiptPipeline(
      gemini: ref.read(geminiServiceV3Provider),
...
/// 
/// Flow: Camera → Gemini Vision → Validator → Confidence Gate
///       → (auto-save OR review screen) → Hive → Ledger
class ReceiptPipeline {
  final GeminiServiceV3 gemini;
  ...
  Future<Receipt> process({
    ...
    try {
      ...
      final json = await gemini.analyzeReceiptImage(
