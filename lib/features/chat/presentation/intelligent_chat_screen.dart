...
import 'package:ghost_accountant/core/presentation/widgets/ghost_logo.dart';
import 'package:ghost_accountant/features/chat/services/simple_chat_service.dart';
import 'package:ghost_accountant/features/receipts/services/hive_transaction_provider.dart';
import 'package:ghost_accountant/core/services/permission_service.dart';
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (messages.isEmpty) {
        ...
        final welcomeMessage = ChatMessage(
          text: 'Hello! I\'m Ghost Accountant, your intelligent financial assistant. I can help you:\n\n• Track expenses and income\n• Manage loans and IOUs\n• Analyze spending patterns\n• Provide financial insights\n\nJust tell me what you spent or ask me anything!',
          isUser: false,
