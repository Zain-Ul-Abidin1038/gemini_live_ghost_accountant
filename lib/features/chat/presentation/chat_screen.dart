...
import 'package:ghost_accountant/core/theme/glass_widgets.dart';
...
import 'package:ghost_accountant/core/services/aws_memory_service.dart';
import 'package:ghost_accountant/core/services/error_handler_service.dart';
import 'package:ghost_accountant/core/services/validation_service.dart';
...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  void initState() {
    ...
    _messages.add(ChatMessage(
      text: 'Hello! I\'m your Ghost Accountant AI assistant. Ask me anything about your expenses, tax deductions, or financial insights.',
      isUser: false,
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      // Get Gemini service with timeout
...
Please provide a helpful response about their expenses, tax deductions, or financial insights.''';
      ...
      final result = await ref.read(errorHandlerProvider).executeWithRetry(
        operation: () => geminiService.sendMessage(
