...
import 'package:ghost_accountant/features/finance/services/ai_finance_parser.dart';
...
Respond as Ghost Accountant, a helpful financial AI assistant. Be conversational, ask clarifying questions when needed, and provide actionable insights.''';

      final response = await geminiService.sendMessage(
        prompt: contextPrompt,
        systemInstruction: '''You are Ghost Accountant, an intelligent financial AI assistant.
...
- Always be proactive and helpful''',
      ...
      return {
        'success': true,
        'message': 'Hello! I\'m Ghost Accountant. I can help you track expenses, manage loans, and provide financial insights. What would you like to do?',
        'thoughtSignature': '',
      };
    }
  }
