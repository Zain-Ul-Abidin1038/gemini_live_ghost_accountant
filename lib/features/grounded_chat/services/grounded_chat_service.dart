...
import 'package:ghost_accountant/features/grounded_chat/services/grounded_search_service.dart';
    ...
    try {
      ...
      if (isDomainSpecific) {
        ...
        result = await groundedSearch.searchWithDocumentGrounding(
          query: message,
          context: 'You are Ghost Accountant, an AI financial assistant.',
        );
      } else {
