...
final geminiRouterProvider = Provider((ref) => GeminiRouter());

/// Hybrid Model Router
/// Automatically selects Flash vs Pro based on workload
class GeminiRouter {
  static const String flashModel = 'gemini-3-flash-preview';
  static const String proModel = 'gemini-3-pro-preview';
