...
VisionGhostService (Business Logic)
    ↓
GeminiServiceV3 (AI Integration)
    ↓
Gemini Vision API
```
...
- ✅ Sent securely to Gemini API (HTTPS)
...
> "Built with Google's Gemini Vision API, advanced camera processing, and real-time streaming architecture. Analyzes frames every 3 seconds with sub-second latency, providing conversational advice using structured AI prompts and JSON parsing."
