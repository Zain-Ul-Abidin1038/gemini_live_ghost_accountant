...
```markdown
# 🎉 Ghost Accountant v1.0.0 - First Production Release
...
3. Install APK
4. Get free Gemini API key from [Google AI Studio](https://makersuite.google.com/app/apikey)
...
```markdown
[![Release](https://img.shields.io/github/v/release/your-org/ghost_accountant)](https://github.com/your-org/ghost_accountant/releases)
```
...
- Title: "🎉 Ghost Accountant v1.0.0 Released!"
...
**Q: Is the app free?**
A: Yes, the app is free. Gemini API costs ~$0.78/month for typical usage.
