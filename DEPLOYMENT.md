# 🚀 Deployment Guide - Ghost Accountant

## Overview

Ghost Accountant uses automated CI/CD pipelines with GitHub Actions for professional-grade deployment to multiple platforms.
...
```
https://github.com/YOUR_USERNAME/ghost_accountant/releases
```
...
```markdown
![CI](https://github.com/YOUR_USERNAME/ghost_accountant/workflows/CI/badge.svg)
![Deploy Web](https://github.com/YOUR_USERNAME/ghost_accountant/workflows/Deploy%20Web/badge.svg)
![Build Android](https://github.com/YOUR_USERNAME/ghost_accountant/workflows/Build%20Android/badge.svg)
```
