...
The Grounded Search feature enables Ghost Accountant to provide factual, verifiable answers by searching the web or specific document datastores in real-time. This ensures users get accurate, up-to-date information with proper citations.
...
│                   External APIs                              │
│  ┌────────────────────┐  ┌──────────────────────────────┐  │
│  │  Gemini API with   │  │  Vertex AI Search            │  │
...
- **Use Cases**: 
  ...
  - Market prices
  - Recent news
- **API**: Gemini with `googleSearchRetrieval` tool
...
- **API**: Gemini with Vertex AI Search datastore
...
- [Gemini Grounding Documentation](https://ai.google.dev/gemini-api/docs/grounding)
- [Vertex AI Search](https://cloud.google.com/generative-ai-app-builder/docs/enterprise-search-introduction)
- [Google Search Grounding](https://ai.google.dev/gemini-api/docs/grounding#google-search)
