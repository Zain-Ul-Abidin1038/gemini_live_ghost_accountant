...
# Or if using SSH:
git remote add origin git@github.com:YOUR_USERNAME/ghost_accountant.git
...
1. **Go to your repository on GitHub**
   ```
   https://github.com/YOUR_USERNAME/ghost_accountant
   ```
...
4. **Fill in release information:**
   - **Tag version:** `v1.0.0`
   - **Release title:** `Ghost Accountant v1.0.0 - AI-Powered Financial Life OS`
...
1. Visit your repository: `https://github.com/YOUR_USERNAME/ghost_accountant`
...
git remote set-url origin https://github.com/YOUR_USERNAME/ghost_accountant.git
```
