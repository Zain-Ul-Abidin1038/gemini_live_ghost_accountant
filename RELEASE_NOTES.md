# Ghost Accountant v1.0.0 - Release Notes
...
Ghost Accountant v1.0.0 is the first production release of the world's first **AI-Powered Financial Life Operating System**. This release includes 50+ integrated AI systems working together to provide intelligent, autonomous financial management.
...
- **AI-Powered OCR** - Gemini 3 Flash for instant text extraction
...
### AI & Intelligence
- **Google Gemini 3 Flash/Pro** - Multimodal AI
...
3. **Add API Key** - Configure Gemini API key in settings
