...
## Overview
Restore cloud AI and backend services to Ghost Accountant after they were previously removed and converted to mock implementations. This includes Gemini 3 Pro AI integration and AWS Amplify services.

## Background
The app previously had all cloud services (Google AI/Gemini and AWS Amplify) removed and converted to mock implementations for local-only operation. Recent changes show the Gemini service being restored with real API integration, indicating a need to properly restore cloud functionality.
...
**Acceptance Criteria:**
- Receipt images are analyzed by Gemini 3 Pro Vision API
...
**Acceptance Criteria:**
- Chat interface connects to Gemini 3 Pro with high-level thinking
...
- Gemini API key must be securely stored (not hardcoded)
...
## Open Questions
1. Should we support multiple AI providers (Gemini, OpenAI, Claude)?
